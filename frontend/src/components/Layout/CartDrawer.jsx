...
const CartDrawer = ({ drawerOpen, toggleCartDrawer }) => {
  return (
    <div
      className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rm] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${
    ...
    >
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        <h2 className="text-xl font-semibold mb-4">yourCart</h2>
